  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-100 p-4 sm:p-0 relative'>
      ...
      <div className='flex flex-col sm:flex-row bg-white shadow-lg w-full sm:w-3/4 h-auto sm:h-[575px] border rounded-2xl border-transparent overflow-hidden'>
        ...
        {/* Left Panel */}
        <div className='flex items-center justify-center w-full sm:w-2/5 h-67 lg:h-120 md:h-120 xl:h-120 sm:h-120 quicksand text-white bg-[#33658a] rounded-t-2xl rounded-b-none sm:rounded-tl-2xl sm:rounded-bl-2xl sm:rounded-tr-none flex-col gap-4 sm:gap-10 p-4'>
        ...
        <div className='flex items-center justify-center flex-col gap-2 w-full sm:w-3/5 h-auto sm:h-full quicksand text-[#33658a] p-4 sm:p-0'>
          ...
          <form className='mt-4 w-full max-w-sm px-4 sm:px-0' onSubmit={handleLogin}>
            ...
            {loginPage && <Link to='/forgot-password'><p className='text-center mt-2 mb-4 text-sm sm:text-base'>Forgot your password?</p></Link>}
